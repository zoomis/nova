...
setuptools.setup(name='nova',
      ...
      scripts=['bin/nova-all',
               ...
               'bin/bm_flavor_extra_specs_list',
               'bin/bm_flavor_extra_specs_set',
               'bin/bm_interface_create',
               'bin/bm_interface_destroy',
               'bin/bm_interface_list',
               'bin/bm_kill_dnsmasq',
               'bin/bm_kill_shellinaboxd',
               'bin/bm_node_create',
               'bin/bm_node_destroy',
               'bin/bm_node_list',
